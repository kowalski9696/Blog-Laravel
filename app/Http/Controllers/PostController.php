...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Post Berhasil Di Hapus(file di simpan di BIN)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success','Data Berhasil Di Restore (sialhkan cek,List Post)'); 
    }
    ...
    public function kill($id){
        ...
        return redirect()->back()->with('success','Data Berhasil Di Hapus Secara Permanen!!!'); 
